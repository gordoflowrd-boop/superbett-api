...
// Resumen general por banca (ventas, premios, resultado)
// =============================================
...
// =============================================
// GET /api/reportes/banca?banca_id=&fecha=
// Detalle de venta por banca para un día
// =============================================
router.get('/banca', requireRol('admin', 'central', 'rifero'), async (req, res) => {
...
// Ver exposición acumulada por número (para admin ver riesgo)
// =============================================
